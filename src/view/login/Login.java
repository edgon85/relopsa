...
import interfaces.UsuarioLogin;
 ...
 * @author gonza
 */
public class Login extends javax.swing.JFrame implements UsuarioLogin{
    ...
    private void initComponents() {
        ...
        txpPasswordLogin = new javax.swing.JPasswordField();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(txpPasswordLogin, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(txpPasswordLogin, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnAceptarLogin)
                    .addComponent(btnCancelarLogin))
    ...
    private void btnAceptarLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarLoginActionPerformed
        ...
        String pass = txpPasswordLogin.getText();
        ...
        try {
            ...
            if (cap.equals("Administrador")) {
               ...
               PrincipalAdmin pAdmin = new PrincipalAdmin();
                ...
                pAdmin.pack();
                pAdmin.setSize(xsize, ysize);
               pAdmin.setResizable(false);
               pAdmin.setExtendedState(MAXIMIZED_BOTH);
                pAdmin.labelUserPAdmin.setText(usuario);
                pAdmin.jLabelCargopAdmin.setText(cap);
            }
            if (cap.equals("Vendedor")) {
                this.setVisible(false);
                PrincipalAdmin windowUser = new PrincipalAdmin();
            ...
            System.out.println("Error en base de dato " + e);
        }
    } 
